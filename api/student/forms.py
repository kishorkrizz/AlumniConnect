...
class StudentCreationForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'usn': forms.TextInput(attrs={"class": "form-control", "placeholder": "Enter the Rollno"}),
            
            'phone': forms.TextInput(attrs={"class": "form-control", "placeholder": "Enter the phone number"}),
            'rv_email': forms.EmailInput(attrs={"class": "form-control", "placeholder": "Enter the SIET Email"}),
